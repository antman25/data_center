...
cat /root/ca/certs/ca.cert.pem /root/ca/intermediate/certs/intermediate_ca.cert.pem /root/ca/intermediate/private/intermediate_ca.decrypted-key.pem > /root/ca/intermediate/certs/int-full-chain.pem
